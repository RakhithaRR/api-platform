...
Feature: Agent proxies are authored and managed through the control plane
  ...
  Scenario: A minimal Agent proxy is created with a generated handle, read, listed and deleted
    ...
    And the JSON response field "a2a.operationConfigs.policies" should not exist
    And the JSON response field "a2a.operationConfigs.operations" should not exist
  ...
  Scenario: A full Agent proxy keeps its explicit handle, nested card and free-form extensions
    ...
    When I create an Agent proxy via the control plane from "resources/templates/agent-proxy.yaml" with values:
      ...
      | a2a.operationConfigs.policies   | [{"name":"set-headers","version":"v1","params":{"response":{"headers":[{"name":"X-Agent-Chain","value":"common"}]},"signing":true}}]                                                                                                                                                                                                                                                                                                                                                                                                                                 |
      | a2a.operationConfigs.operations | [{"name":"SendMessage","resilience":{"timeout":"30s"}}]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
  ...
  Scenario Outline: An Agent proxy payload that breaks the shared contract is rejected: <case>
    ...
    Examples:
      ...
      | missing protocol                 | 400    | VALIDATION_FAILED | {"displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}}                                                                        |
      | second protocol block            | 400    | VALIDATION_FAILED | {"displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}},"mcp":{}}                                              |
      ...
      | generic protocolConfig wrapper   | 400    | VALIDATION_FAILED | {"displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","protocolConfig":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}}                                            |
      | legacy top-level transports      | 400    | VALIDATION_FAILED | {"displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}},"transports":[{"protocolBinding":"JSONRPC"}]}          |
      | legacy top-level protocolVersion | 400    | VALIDATION_FAILED | {"displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","protocolVersion":"1.0","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}}                               |
      | root-level agentCard             | 400    | VALIDATION_FAILED | {"displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}},"agentCard":{"public":{"mode":"passthrough"}}}         |
      | card under operationConfigs      | 400    | VALIDATION_FAILED | {"displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}],"agentCard":{"public":{"mode":"passthrough"}}}}}         |
      | top-level policies               | 400    | VALIDATION_FAILED | {"displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}},"policies":[{"name":"cors","version":"v1"}]}           |
      | explicit null                    | 400    | VALIDATION_FAILED | {"displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","vhost":null,"upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}}                                          |
      | missing displayName              | 400    | VALIDATION_FAILED | {"version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}}                                                                                |
      | wrongly typed version            | 400    | VALIDATION_FAILED | {"displayName":"Rejected","version":1,"projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}}                                                            |
      | reserved handle                  | 400    | VALIDATION_FAILED | {"id":"fetch-agent-card","displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}}                               |
      | handle outside the grammar       | 400    | VALIDATION_FAILED | {"id":"Rejected.Agent","displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}}                                 |
      | context without a leading slash  | 400    | VALIDATION_FAILED | {"displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","context":"agent","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}}                                     |
      | upstream with an unsupported URL | 400    | VALIDATION_FAILED | {"displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"file:///etc/passwd"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}}                                                                 |
      | credential type with no value    | 400    | VALIDATION_FAILED | {"displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099","auth":{"type":"api-key","header":"X-Key"}}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}}            |
      | empty object                     | 400    | VALIDATION_FAILED | {}                                                                                                                                                                                                                                                                                                                 |
      | unknown project                  | 404    | PROJECT_NOT_FOUND | {"displayName":"Rejected","version":"v1.0","projectId":"no-such-agent-project","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}}                                                      |
      | unknown associated gateway       | 404    | GATEWAY_NOT_FOUND | {"displayName":"Rejected","version":"v1.0","projectId":"${CTX:projectHandle}","associatedGateways":[{"id":"no-such-agent-gateway"}],"upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}} |
  ...
  Scenario: A handle is unique within the organization and a secret handle is never echoed
    ...
    When I send a "PUT" request to the control plane at "/agent-proxies/no-such-agent-proxy" with body:
      """
      {"displayName":"Missing","version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}}
      """
    Then the response status code should be 404
    And the JSON response field "code" should be "AGENT_PROXY_NOT_FOUND"
  ...
  Scenario Outline: A typed A2A configuration that could never deploy is rejected: <case>
    ...
    Examples:
      | case                                | a2a                                                                                                                                                                                                                                                                                                                       |
      | unregistered protocol version       | {"protocolVersion":"9.9","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}                                                                                                                                                                                                                               |
      | missing operationConfigs            | {"protocolVersion":"1.0"}                                                                                                                                                                                                                                                                                                 |
      | operationConfigs without transports | {"protocolVersion":"1.0","operationConfigs":{"policies":[{"name":"cors","version":"v1"}]}}                                                                                                                                                                                                                                |
      | empty transports                    | {"protocolVersion":"1.0","operationConfigs":{"transports":[]}}                                                                                                                                                                                                                                                            |
      | unknown binding                     | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"GRPC"}]}}                                                                                                                                                                                                                                  |
      | duplicate binding                   | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC","pathPrefix":"/a"},{"protocolBinding":"JSONRPC","pathPrefix":"/b"}]}}                                                                                                                                                             |
      | unknown operation                   | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}],"operations":[{"name":"Teleport"}]}}                                                                                                                                                                                            |
      | duplicate operation                 | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}],"operations":[{"name":"SendMessage"},{"name":"SendMessage"}]}}                                                                                                                                                                  |
      | unknown typed field                 | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]},"routing":"sticky"}                                                                                                                                                                                                            |
      | card path with a trailing slash     | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]},"agentCard":{"public":{"path":"/cards/"}}}                                                                                                                                                                                     |
      | card path with a query              | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]},"agentCard":{"public":{"path":"/card.json?v=1"}}}                                                                                                                                                                              |
      | unknown card mode                   | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]},"agentCard":{"public":{"mode":"cached"}}}                                                                                                                                                                                      |
      | managed card without content        | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]},"agentCard":{"public":{"mode":"managed"}}}                                                                                                                                                                                     |
      | passthrough card with content       | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]},"agentCard":{"public":{"mode":"passthrough","content":{"name":"x"}}}}                                                                                                                                                          |
      | managed card with rewriteUrls       | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]},"agentCard":{"public":{"mode":"managed","rewriteUrls":true,"content":{"name":"x","description":"x","version":"1.0.0","supportedInterfaces":[],"capabilities":{},"defaultInputModes":[],"defaultOutputModes":[],"skills":[]}}}} |
      | non-boolean rewriteUrls             | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]},"agentCard":{"public":{"mode":"passthrough","rewriteUrls":"yes"}}}                                                                                                                                                             |
      | managed card missing required keys  | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]},"agentCard":{"public":{"mode":"managed","content":{"name":"Incomplete","description":"No skills or interfaces"}}}}                                                                                                             |
      | typed signing on the public card    | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]},"agentCard":{"public":{"mode":"passthrough","signing":{"enabled":false}}}}                                                                                                                                                     |
      | typed signing on the protected card | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]},"agentCard":{"protected":{"mode":"passthrough","signing":{"enabled":false}}}}                                                                                                                                                  |
      | protected card with a path          | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]},"agentCard":{"protected":{"mode":"passthrough","path":"/extended.json"}}}                                                                                                                                                      |
      | protected card with policies        | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]},"agentCard":{"protected":{"mode":"passthrough","policies":[{"name":"cors","version":"v1"}]}}}                                                                                                                                  |
      | protected card without a mode       | {"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]},"agentCard":{"protected":{"rewriteUrls":true}}}                                                                                                                                                                                |
  ...
  Scenario: Agent proxy mutations need a mutating scope and bodies must be JSON
    ...
    When I send a "POST" request to the control plane at "/agent-proxies" with header "Content-Type" set to "text/plain" with body:
      """
      {"displayName":"Plain","version":"v1.0","projectId":"${CTX:projectHandle}","upstream":{"main":{"url":"http://a2a-trip-planner:9099"}},"protocol":"a2a","a2a":{"protocolVersion":"1.0","operationConfigs":{"transports":[{"protocolBinding":"JSONRPC"}]}}}
      """
